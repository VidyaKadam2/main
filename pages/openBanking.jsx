...
const Banking = () => {
    ...
    return (
        <main className=''>
          ...
          <div className=' bg-black sm:h-20 sm:bg-black w-[360px] sm:w-[1263px] '>
...
<div className='sm:hidden'><img src='/img1/11.png' className='h-[209.03px] w-[360px]'/></div>
<div className=' flex sm:bg-8-img sm:bg-cover sm:h-[800px]  bg-black sm:w-[1263px] w-[360px] h-[304px]'>
...
<div className=' flex bg-[#0057FF] sm:h-96 sm:w-[1263px] h-[460px] w-[360px] justify-center sm:text-center  text-white'>
...
<div className='sm:h-96 flex flex-col  sm:text-center sm:bg-white bg-[#595959] sm:w-[1263px] w-[360px] h-[326px]'>
  <p className=' sm:font-bold sm:text-4xl sm:mt-14 sm:tracking-normal sm:font-sans mt-[31px] text-lg text-white sm:text-black sm:ml-0 ml-[36px] tracking-wider'>Many big comapany trusted us</p>
  ...
  <p className='text-center text-[#545454] mt-8 tracking-wider text-lg hidden sm:flex ml-[250px]'>Our clients include multinational corporations, financial institutions, private equity funds,</p>
  <p className='text-center text-[#545454]  tracking-wider text-lg hidden sm:flex ml-[250px]'> domestic corporations, joint ventures, emerging companies, start-ups, non-governmental</p>
  <p className='text-center text-[#545454]  tracking-wider text-lg hidden sm:flex ml-[250px]'>  organizations, international organizations, individuals and government.</p>
...
<div className=' sm:mt-12 text-center sm:font-bold sm:text-4xl sm:tracking-normal text-lg font-medium tracking-wide sm:ml-72  mt-[58px] mr-[65px] w-[234px] ml-[65px] sm:w-[700px]'>Fintract Global Open Banking features</div>

<div className="flex w-[360px]  mt-[60px] items-center justify-center px-20 text-center sm:hidden">
             <Swiper 
    ...
    >
      <SwiperSlide>    <div className='flex flex-col w-[195px] h-[190px] bg-white shadow-[0_0px_22px_-2px_rgb(0,0,0,0.25)] justify-center text-center'><img className='w-[162px] h-[97.8px] mt-[7px] ml-[16px]' src='/img1/image 39.png'/>
    ...
    <p className='text-xs tracking-tight'> accounts (even from different banks).</p></div></SwiperSlide>
      ...
      <SwiperSlide>    <div className='flex flex-col w-[195px] h-[190px] bg-white shadow-[0_0px_22px_-2px_rgb(0,0,0,0.25)] justify-center text-center'><img className='w-[162px] h-[97.8px] mt-[7px] ml-[16px]' src='/img1/16.png'/>
    ...
    <SwiperSlide>    <div className='flex flex-col w-[195px] h-[190px] bg-white shadow-[0_0px_22px_-2px_rgb(0,0,0,0.25)] justify-center text-center'><img className='w-[162px] h-[97.8px] mt-[7px] ml-[16px]' src='/img1/15.png'/>
    ...
    <SwiperSlide>    <div className='flex flex-col w-[195px] h-[190px] bg-white shadow-[0_0px_22px_-2px_rgb(0,0,0,0.25)] justify-center text-center'><img className='w-[162px] h-[97.8px] mt-[7px] ml-[16px]' src='/img1/17.png'/>
    ...
    <SwiperSlide>    <div className='flex flex-col w-[195px] h-[190px] bg-white shadow-[0_0px_22px_-2px_rgb(0,0,0,0.25)] justify-center text-center'><img className='w-[162px] h-[97.8px] mt-[7px] ml-[16px]' src='/img1/18.png'/>
    ...
    <SwiperSlide>    <div className='flex flex-col w-[195px] h-[220px] bg-white shadow-[0_0px_22px_-2px_rgb(0,0,0,0.25)] justify-center text-center'><img className='w-[162px] h-[97.8px] mt-[7px] ml-[16px]' src='/img1/19.png'/>
    ...
    <SwiperSlide>    <div className='flex flex-col w-[195px] h-[190px] bg-white shadow-[0_0px_22px_-2px_rgb(0,0,0,0.25)] justify-center text-center'><img className='w-[162px] h-[97.8px] mt-[7px] ml-[16px]' src='/img1/20.png'/>
    <p className='text-sm mt-[9.2px] font-normal'>Account Aggregation</p>
    <p className='text-xs mt-[11px] tracking-tight'>The users will be able to add multiple</p>
    <p className='text-xs tracking-tight'> accounts (even from different banks).</p></div></SwiperSlide>

    <SwiperSlide>    <div className='flex flex-col w-[195px] h-[190px] bg-white shadow-[0_0px_22px_-2px_rgb(0,0,0,0.25)] justify-center text-center'><img className='w-[162px] h-[97.8px] mt-[7px] ml-[16px]' src='/img1/13.png'/>
    <p className='text-sm mt-[9.2px] font-normal'>Core Banking</p>
    <p className='text-xs mt-[11px] tracking-tight'>The users will be able to add multiple</p>
    <p className='text-xs tracking-tight'>accounts (even from different banks).</p></div></SwiperSlide>

      <SwiperSlide>    <div className='flex flex-col w-[195px] h-[190px] bg-white shadow-[0_0px_22px_-2px_rgb(0,0,0,0.25)] justify-center text-center'><img className='w-[162px] h-[97.8px] mt-[7px] ml-[16px]' src='/img1/14.png'/>
...
<div className='sm:h-[400px] bg-[#FFEEDA] sm:mt-24 sm:w-[1263px] w-[360px] h-[496px] mt-10'>
  <div className='flex sm:flex-row justify-center flex-col'><img src='/img1/21.png' className='sm:h-80 sm:w-[500px] sm:mt-10 w-[297px] h-[196px]  mt-[24px] sm:ml-0 ml-[30px]'/>
  <div className='sm:h-80 sm:w-[500px] bg-white sm:mt-10 w-[295px] h-[260px] sm:ml-0 ml-[30px] text-center'><p className='sm:mt-10 sm:ml-14 sm:mr-16 sm:text-lg text-xs mt-4 ml-[36px] mr-[26px] sm:tracking-normal tracking-widest'>Open banking allows access and control of consumer banking and financial accounts through third-party applications. It has the potential to reshape the competitive landscape and consumer experience of the banking industry. It raises the potential for both promising gains and grave risks to consumers as more of their data is shared more widely.</p></div>
  </div>
</div>
...
<div className='h-[440px] w-[360px]  bg-white mt-[65px] sm:hidden'>
  <div className='flex flex-col justify-center'><img src='/img1/image 19.png' className=' w-[297px]  ml-[30px] h-[196px] '/>
  <div className='h-[260px] w-[295px] bg-white ml-[30px] text-center '><p className='mt-4 ml-[36px] mr-[26px] text-xs tracking-widest'>Also known as ‘Open Bank Data’, this banking practice provides third-party financial service providers free access to consumer banking, transaction, and other financial data from banks and non-bank financial institutions through the use of application programming interfaces (APIs).</p></div>
  
  </div>
</div>

<div className='sm:h-[400px] bg-[#FFEEDA] sm:mt-24 sm:w-[1263px] w-[360px] h-[496px] mt-4'>
  <div className='flex sm:flex-row justify-center flex-col'><img src='/img1/image 20.png' className='sm:h-80 sm:w-[500px] sm:mt-10 w-[297px] h-[196px]  sm:ml-0 ml-[30px] mt-[24px]'/>
  <div className='sm:h-80 sm:w-[500px] bg-white sm:mt-10 w-[295px] h-[260px] sm:ml-0 ml-[30px] text-center'><p className='sm:mt-10 sm:ml-14 sm:mr-16 sm:text-lg text-xs mt-4 ml-[36px] mr-[26px] sm:tracking-normal tracking-widest'>Our web app is time and labor efficient and offers features to establish user control over cash flow. We estimate that through the OB platform, banks will be able to generate approximately 30% more revenue.</p></div>
  </div>
</div>

<div className='sm:mt-32 sm:text-center mt-[59px] sm:ml-0 ml-[110px] tracking-wide'><p className='sm:text-4xl sm:font-bold sm:tracking-normal text-base font-semibold'>Related Articles</p></div>

<div className='mt-14 flex flex-col sm:flex-row sm:w-[1263px] w-[360px]'>
<div className='flex flex-col w-80 h-128 sm:ml-32  ml-[36px]'>
    ...
    <div className='bg-[#0057FF] shadow-[0_0px_0px_-4px_rgb(0,0,0,0.25)] text-center mt-10 w-24 h-8 rounded sm:ml-24 ml-[80px]'><a href='/a'><p className='text-white text-sm mt-1'>Read more</p></a></div>


  </div>

  <div className='flex flex-col w-80 h-128 ml-[36px] mt-[54px] sm:mt-0 '>
    ...
    <div className='bg-[#0057FF] shadow-[0_0px_0px_-4px_rgb(0,0,0,0.25)] text-center mt-14 w-24 h-8 rounded sm:ml-24 ml-[80px]'><a href='/a'><p className='text-white text-sm mt-1'>Read more</p></a></div>
...
<div className='sm:hidden w-[107px] h-[29px] border border-black mt-[45px] ml-[107px] text-center'><a href='/a'><p>Load more</p></a></div>


<div className='mt-14  flex-row hidden sm:flex'>
<div className='flex flex-col w-80 h-96 ml-32 '>
  ...
  <div className=' flex-col w-80 h-96 ml-10 hidden sm:flex'>
...
<div className='bg-[#0057FF] shadow-[0_0px_0px_-4px_rgb(0,0,0,0.25)] text-center mt-24 w-24 h-8 rounded ml-52'><a href='/a'><p className='text-white text-sm mt-1'>Read more</p></a></div>
...
<div className=' flex flex-col sm:h-40 h-28 bg-[#393939] mt-32 sm:w-[1263px] w-[360px]'>
  ...
  <div className='flex sm:flex-row flex-col w-[360px] sm:w-[1263px] bg-[#393939] sm:h-[420px] h-[1200px]'>
  <div className='flex flex-col w-80 h-96 sm:ml-32 ml-0 '>

    <div className='  sm:justify-center'><img className='sm:w-72 sm:h-48 sm:mt-4 ml-[63px] sm:ml-0 w-[239px] h-[161px]' src='/img1/image 21.png'/></div>
    <ul className=' list-disc ml-4'>
    <li className='text-sm text-white sm:mt-4 sm:mr-20 sm:ml-0 ml-[47px] mt-[22px] '>Our product, powered by analytics, produces a full visualization, combined with a detailed analysis.</li>
    <li className='text-sm text-white sm:mt-4 sm:mr-20 sm:ml-0 ml-[47px] mt-[22px]'>The product offers convenience and time efficiency, enabling a user to compare multiple transactions with ease.</li></ul>
    
  </div>

  <div className='flex flex-col w-80 h-96 sm:ml-10 '>

    <div className='  sm:justify-center'><img className='sm:w-72 sm:h-48 sm:mt-4 ml-[63px] sm:ml-0 w-[239px] h-[161px]' src='/img1/image 24.png'/></div>
    <ul className=' list-disc ml-4'>
    <li className='text-sm text-white sm:mt-4 sm:mr-16 sm:ml-0 ml-[47px] mt-[22px]'>Our product is incredibly safe, owing to the additional layer of security through AISP & PISP APIs.</li>
    <li className='text-sm text-white sm:mt-4 sm:pr-16 sm:ml-0 ml-[47px] mt-[22px]'>The borrower can share their contact details, income, credit score and history with the lender at the click of a button.</li></ul>
    
  </div>

  <div className='flex flex-col w-80 h-96 sm:ml-10 '>

    <div className='sm:justify-center'><img className='sm;w-72 sm:h-48 sm:mt-4 ml-[63px] sm:ml-0 w-[239px] h-[161px]' src='/img1/image 25.png'/></div>
    <ul className=' list-disc ml-4'>
    <li className='text-sm text-white sm:mt-4 sm:mr-14 sm:ml-0 ml-[47px] mt-[22px]'>End to End encryption enables information to be exchanged and stored very safely.</li>
    <li className='text-sm text-white sm:mt-4 sm:mr-16  sm:ml-0 ml-[47px] mt-[22px]'>Our web app allows users to bank from their systems, remotely and conveniently.</li></ul>
    
  </div>
  </div>

  <div className='sm:h-52 bg-black flex sm:flex-row flex-col h-[269px] sm:w-[1263px] w-[360px]'>
  ...
  <div className='h-28 bg-white sm:w-[1263px] w-[360px]'><p className='text-[#FF0000] sm:ml-28 ml-[30px] mt-20 text-xl tracking-widest'>Terms and conditions</p></div>

  <div className=' sm:h-[470px] bg-black h-[722px] sm:w-[1263px] w-[360px]'>
              <div className='flex flex-col'>
                <div className='flex sm:flex-row flex-col'>
                  <div className='flex flex-col'>
                  <img src='/img/FG LOGO_white 4.png' className='sm:w-[80px] sm:h-[60px] sm:ml-[50px] sm:mt-10 w-[45px] h-[36.7px] ml-[33px] mt-[43px]'/>
                  <p className='sm:ml-[50px] text-white font-bold sm:mt-4 sm:text-3xl ml-[33px] mt-[11.3px] text-2xl'>Fintract Global</p>
                  ...
                  <a href='/a'><img src='/img/Group 73.png' className='w-[30px] h-[30px] ml-[33px] sm:ml-[50px]'/></a>
                  <a href='/a'><img src='/img/Group 72.png' className='w-[30px] h-[30px] ml-4 '/></a>
                  <a href='/a'><img src='/img/Group 71.png' className='w-[30px] h-[30px] ml-4 '/></a>
                  <Link href='/a'><img src='/img/Group 70.png' className='w-[30px] h-[30px] ml-4 '/></Link>
                  </div>
                  <div className='h-0.5 w-4/5 bg-[#6B6B6B] sm:hidden ml-[32px] mt-[40px]'><p></p></div>
                  </div>
                  <div className='flex flex-col sm:mt-10 mt-[16px] w-3/3 sm:w-2/3 sm:ml-36 ml-[39px]'>
                    <a href='/a'>
                      <div className='flex flex-row '><img src='/img/Group 67.png' className='sm:w-[40px] sm:h-[40px] w-[30px] h-[30px]'/>
                        <div className='flex flex-col'>
                          <p className='text-white font-semibold sm:ml-6 ml-[14px]'>Address</p>
                          <p className='text-white sm:ml-6 ml-[14px] sm:text-sm  text-xs '>Registered Office: London Office Address</p>
                           <p className='text-white sm:ml-6 ml-[14px] sm:text-sm text-xs'> 71-75, Sheldon Street, Covent Garden</p>
                           <p className='text-white sm:ml-6 ml-[14px] sm:text-sm text-xs'> London, WC2h 9JQ</p>
                        </div>
                      </div>
                    </a>
                    ...
                    <a href='/a'>
                      <div className='flex flex-row sm:mt-8 mt-[11px]'><img src='/img/Group 68.png' className='sm:w-[40px] sm:h-[40px] w-[30px] h-[30px]'/>
                        <div className='flex flex-col'>
                          <p className='text-white font-semibold sm:ml-6 ml-[14px]'>Phone</p>
                          <p className='text-white sm:ml-6 sm:text-sm text-xs ml-[14px]'>+44-2037373227</p>
                        </div>
                      </div>
                    </a>
                    ...
                    <a href='/a'>
                      <div className='flex flex-row  sm:mt-8 mt-[11px]'><img src='/img/Group 69.png' className='sm:w-[40px] sm:h-[40px] w-[30px] h-[30px]'/>
                        <div className='flex flex-col'>
                          <p className='text-white font-semibold sm:ml-6 ml-[14px]'>Email</p>
                          <p className='text-white ml-[14px] sm:text-sm sm:ml-6 text-xs'>contact@fintract.co.uk</p>
                        </div>
                      </div>
                    </a>
                ...
                <p className='text-center text-gray-500 text-xs mt-16 hidden sm:flex sm:justify-center sm:items-center '>Fintract Global takes your privacy very seriously. We may process your personal information for carefully considered and specific purposes which are in our interests and</p>
                <p className='text-center text-gray-500 text-xs  hidden sm:flex sm:justify-center sm:items-center '>enable us to enhance the services we provide, but which we believe also benefit our customers. View our Privacy Policy to learn more about these interests and when we may</p>
                <p className='text-center text-gray-500 text-xs  hidden sm:flex sm:justify-center sm:items-center'>process your information in this way.</p>
                <p className='text-gray-500 text-xs ml-[14px] mr-[10px] sm:hidden mt-[30px] sm:justify-center sm:items-center'>Fintract Global takes your privacy very seriously. We may process your personal information for carefully considered and specific purposes which are in our interests and enable us to enhance the services we provide, but which we believe also benefit our customers. View our Privacy Policy to learn more about these interests and when we may process your information in this way.</p>
                <a href='/a' className='text-sm text-white text-center mt-1'>Click here</a>
                <div className='sm:ml-96 ml-0'>
                <hr className='w-20 sm:justify-center sm:items-center sm:ml-52 ml-36 mr-96'></hr></div>
                <p className='text-center text-gray-500 text-xs mt-2'>Copyright ©2021 All rights reserved.</p>
              </div>
            </div>
